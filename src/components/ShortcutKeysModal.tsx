...
import { Keyboard, X, Printer, Save, Search, RefreshCw, FileText, Camera, Scan, Layers } from 'lucide-react';
...
export default function ShortcutKeysModal({ isOpen, onClose }: ShortcutKeysModalProps) {
  ...
  const shortcutGroups = [
    {
      title: '⚡ সাধারণ সফটওয়্যার অ্যাকশন',
      items: [
        { key: 'Ctrl + P', desc: 'সরাসরি প্রিন্ট প্রিভিউ উইন্ডো খুলুন', icon: Printer },
        { key: 'Ctrl + S', desc: 'চলতি প্রজেক্ট ফাইল সেভ করুন', icon: Save },
        { key: 'Ctrl + K', desc: 'কুইক সার্চ ও মোট সার্ভিস খুঁজুন', icon: Search },
        { key: 'Ctrl + O', desc: 'নতুন ছবি বা ফাইল ওপেন / আপলোড করুন', icon: FileText },
    ...
    {
      title: '📑 স্ক্যানার ও পিডিএফ শর্টকাট',
      items: [
